// frontend/src/components/SkipQcModal.jsx
...
function SkipQcModal({ isOpen, onClose, document, onSubmitSuccess }) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await apiCall(`/documents/${document.id}/submit-review-direct`, "POST", {
        reviewers: reviewerIds,
        due_date: dueDate,
      });

      toast.success("Document submitted for technical review (QC skipped)!", {
        id: toastId,
      });
      onSubmitSuccess();
      handleClose();
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                <Dialog.Title className="text-xl font-bold text-white">
                  Submit for Technical Review (Skip QC)
                </Dialog.Title>
          ...
          <div className="px-6 py-5">
            ...
            <div className="mb-4 p-3 bg-amber-50 border border-amber-200 rounded-lg">
              <p className="text-sm text-amber-800">
                ⚠️ <strong>Note:</strong> This document will skip Quality
                Control and go directly to Technical Review. Only use this for
                low-risk documents.
              </p>
            </div>
            ...
            <div className="mb-4">
              <label
                htmlFor="skip-qc-due-date"
                className="block text-sm font-semibold text-gray-700 mb-2"
              >
                Review Due Date <span className="text-error-600">*</span>
              </label>
              <input
                type="date"
                id="skip-qc-due-date"
