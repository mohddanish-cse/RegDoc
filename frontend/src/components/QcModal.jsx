        ...
        <Dialog.Panel className="w-full max-w-md rounded-lg bg-white p-6 shadow-xl">
          ...
          <div className="mt-6 flex gap-4">
            <button
              ...
              className="px-4 py-2 bg-purple-600 text-white rounded-md font-semibold hover:bg-purple-700 disabled:opacity-50"
            >
              {isSubmitting ? "Submitting..." : "Submit QC Review"}
            </button>
            <button
              onClick={handleClose}
              disabled={isSubmitting}
